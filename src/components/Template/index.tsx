  ...
  return (
    <body className="light" id="top">
      <header className="header center">
        ...
        <nav className="nav center">
          ...
          <button type="button" aria-label="toggle theme" className="btn btn--icon">
            <i aria-hidden="true" id="btn-theme" className="fas fa-moon" />
          </button>
      ...
      <main>
        ...
        <div className="about center">
          ...
          <p className="about__desc">
            Consectetur neque sed quam molestiae consectetur nesciunt sit alias Vitae libero
            perferendis reprehenderit optio veritatis Accusantium at voluptatum cumque temporibus et
            Explicabo iste porro quis numquam distinctio Repellendus adipisci nam perferendis amet
            eaque hic Voluptates
          </p>
          ...
          <div className="projects__grid">
            <div className="project">
              ...
              <p className="project__description">
                Ipsum accusamus ea excepturi aliquid eligendi amet. Explicabo sapiente debitis
                labore sed ipsam Mollitia repellat illum quod unde beatae Quis
              </p>
      ...
      <footer className="footer">
        <a href="https://github.com/rajshekhar26/cleanfolio-minimal" className="link footer__link">
