...
function AddEditContainer({ product }: AddEditContainerProps) {
  ...
  return (
    <div className="product__form">
      <h3 className="product__form__title">{product ? product.name : 'Create new Product'}</h3>
      ...
      <form id="postForm" className="post-form" onSubmit={formik.handleSubmit}>
        <div className="form__group">
          ...
          {formik.errors.name ? <div className="invalid-field">{formik.errors.name}</div> : null}
        </div>
        ...
        <div className="form__group mb-3">
          ...
          {formik.errors.code ? <div className="invalid-field">{formik.errors.code}</div> : null}
        </div>
        ...
        <div className="row">
          ...
          <div className="form__group col-md-6 mb-3">
            ...
            />
            {formik.errors.type ? <div className="invalid-field">{formik.errors.type}</div> : null}
          </div>
        </div>
        ...
        <div className="form__group mb-3">
          ...
          />
          {formik.errors.price ? <div className="invalid-field">{formik.errors.price}</div> : null}
        </div>
        ...
        <div className="input-group mb-3" data-id="imageSource" data-image-source="upload" hidden>
        ...
        <ul className="product__form__stack">
          ...
          <li className="product__form__stack-item">
            <button type="submit" className="btn btn--outline" disabled={isSaveLoading}>
